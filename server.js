...
if (useV6) {
	...
	app.use(
		'/public/v6/',
		express.static(path.join(__dirname, '/node_modules/govuk_frontend_toolkit'))
	)
	app.use(
...
if (promoMode === 'true') {
	...
	app.locals.cookieText =
		'GOV.UK uses cookies to make the site simpler. <a href="/docs/cookies">Find out more about cookies</a>'
...
const v1_routes = require('./app/routes_v1.js')
app.use('/v1', v1_routes)

const v2_routes = require('./app/routes_v2.js')
app.use('/v2', v2_routes)

const v3_routes = require('./app/routes_v3.js')
app.use('/v3', v3_routes)

const v4_routes = require('./app/routes_v4.js')
app.use('/v4', v4_routes)

const v5_routes = require('./app/routes_v5.js')
app.use('/v5', v5_routes)
